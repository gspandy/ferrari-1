				...
				<div class="col-xs-12">
					<div class="box">
			            <div class="box-header">
			            	...
			            	<button class="btn btn-info btn-xs addFerrari" type="button">+新增任务[ferrari-corn]</button>
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
					<div class="form-group">
						<label for="firstname" class="col-sm-3 control-label">任务Key</label>
						<div class="col-sm-9"><input type="text" class="form-control" name="triggerKeyName" placeholder="请输入任务Key[不支持修改]" minlength="4" maxlength="100" ></div>
					</div>
					<div class="form-group">
						<label for="lastname" class="col-sm-3 control-label">任务Corn</label>
						<div class="col-sm-9"><input type="text" class="form-control" name="cronExpression" placeholder="请输入任务Corn[允许修改]" maxlength="100" ></div>
					...
					<div class="form-group">
						<label for="lastname" class="col-sm-3 control-label">期望执行的类</label>
						<div class="col-sm-9"><input type="text" class="form-control" name="run_class" placeholder="期望执行的类[不支持修改]" maxlength="200" ></div>
					</div>
					<div class="form-group">
						<label for="lastname" class="col-sm-3 control-label">期望运行的方法</label>
					...
					<div class="form-group">
						...
						<div class="col-sm-9"><input type="text" class="form-control" name="run_method_args" placeholder="方法入参，多个参数用 ,分隔[不支持修改]" maxlength="200" ></div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-9">
							<button type="submit" class="btn btn-primary"  >保存</button>
